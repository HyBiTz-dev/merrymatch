...
function RegisterMainPage() {
          ...
          >
            ...
            <div id="input-container-3" className="flex justify-around">
              <div id="hobbies-interests-input">
                ...
                <input
                  className="border bg-white rounded-lg p-3 w-[56.4rem] focus:border-purple-500 outline-none"
                  id="hobbiesInterests"
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col bg-main w-full h-[48rem] font-nunito">
        <header className="flex justify-around h-36 mb-20 mt-20">
